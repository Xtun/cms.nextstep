...
!function(d){var m=function(a,b){this.element=d(a);this.language=b.language||this.element.data("date-language")||"en";this.language=this.language in n?this.language:"en";this.format=g.parseFormat(b.format||this.element.data("date-format")||"mm/dd/yyyy");this.picker=d(g.template).appendTo("body").on({click:d.proxy(this.click,this),mousedown:d.proxy(this.mousedown,this)});this.isInput=this.element.is("input");if((this.component=this.element.is(".date")?this.element.find(".add-on"):!1)&&0===this.component.length)this.component=
...
d.fn.datepicker.defaults,l)));"string"==typeof a&&"function"==typeof e[a]&&e[a].apply(e,b)})};d.fn.datepicker.defaults={};d.fn.datepicker.Constructor=m;var n=d.fn.datepicker.dates={en:{days:"Sunday Monday Tuesday Wednesday Thursday Friday Saturday Sunday".split(" "),daysShort:"Sun Mon Tue Wed Thu Fri Sat Sun".split(" "),daysMin:"Su Mo Tu We Th Fr Sa Su".split(" "),months:"January February March April May June July August September October November December".split(" "),monthsShort:"Jan Feb Mar Apr May Jun Jul Aug Sep Oct Nov Dec".split(" ")}},
